<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    <a class="sidebar-brand d-flex align-items-center justify-content-center bg-gradient-success" href="/home">
        <div class="sidebar-brand-icon">
            <img src="{{ asset('/img/gajayana.png') }}">
        </div>
        <div class="sidebar-brand-text mx-3">Universitas Gajayana</div>
    </a>
